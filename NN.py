...
class NN:
    ...
    def seeScore(self):
        ...
        score = self.model.score(valid_vect, self.validation_labels) # return the score
        return score
...
#
#     model = MLPClassifier(solver = 'lbfgs', learning_rate='adaptive',early_stopping=True, hidden_layer_sizes =(64,16), batch_size=1024, verbose = True)
#
